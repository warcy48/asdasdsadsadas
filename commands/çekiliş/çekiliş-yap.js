...
let prefix = ayarlar.prefix 
 if(!message.member.permissions.has('ADMINISTRATOR')) {
    const embed = new Discord.MessageEmbed()
      .setDescription(`**:x:Ne yazık ki bu komutu kullanmaya yetkin yok.**`)
 ...
 client.giveawaysManager.start(giveawayChannel, {
            ...
            giveaway: "🎉 **ÇEKİLİŞ** 🎉",
                ...
                hostedBy: "Çekiliş Başlatanı: {user}",
                winners: "kazanan(lar)",
...
units: {
    ...
    message.channel.send(`🎉 **Çekiliş** ${giveawayChannel} adlı kanalda başlatıldı! @everyone @here`).then(a => a.delete({timeout: 10000}));
};
